(* StaticWord8ArraySlice -- SML Basis Library 
   sestoft@dina.kvl.dk 2000-10-24
   Modified for Static buffers by IG 2014-11-11
*)
...
fun slice (a, i, len) =
    let val alen = StaticWord8Array.length a
    in 
	case len of 
...
fun full a = (a, 0, StaticWord8Array.length a);
